...
~/vcftools/bin/vcftools --gzvcf  $i --max-missing 0.80 --min-alleles 2 --max-alleles 2 --maf 0.05 --remove-indels --minDP 6 --recode --recode-INFO-all --out filtered_vcf_files/${STEM}_filtered
done
